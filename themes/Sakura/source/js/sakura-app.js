...
$(document).ready(function () {
  ...
  changeBG('#springfastival', 'https://hesifan.top/medias/spring-img/denglong.png')
  ...
  changeBGnoTrans('#springfastival', 'https://hesifan.top/medias/spring-img/denglong.png')
