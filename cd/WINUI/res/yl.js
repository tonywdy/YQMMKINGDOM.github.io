window.YL = {
  info: {
    ...
    iconBtnStart: 'yoast',
    author: 'Yuri2',
    contactInformation: 'wudingyi1020@163.com',
    officialWebsite: 'https://kwblog.netlify.app',
    copyrightDetail: 'KWOS已授权本产品使用。KWOS禁止任何未经作者授权的使用、修改、二次发布，包括从本产品中剥离KWOS独立使用等侵权行为，违者将追究法律责任。',
    otherStatements: '',
  },
  data: {},
  lang: function (key) {
