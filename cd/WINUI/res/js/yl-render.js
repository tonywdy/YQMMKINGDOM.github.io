    ...
    methods: {
      ...
      initRuntime: function (first) {
        ...
        if (first && !YL.static.serialNumber) {
          YL.onReady(function () {
            setTimeout(function () {
              YL.msg("KWOS v" + YL.info.version + " 社区版", '当前KWOS为社区版，仅限个人用户学习使用，禁止商用及企业使用。欢迎使用支付宝扫描二维码对作者进行捐赠，表达您对KINGWDY的支持~<br/><br/><img style="width: 100%" src="https://gitlab.com/KINGWDY/tgbb/-/raw/main/EBA5FF7A-2505-43A8-99F5-257745FAFAAA.jpeg"/></p>');
            }, 1500)
          });
        }
