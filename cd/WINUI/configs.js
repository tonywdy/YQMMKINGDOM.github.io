YL.static = {
  /** “关于”信息 */
  softwareName: 'KWOS', //网站名。请在此处填写您自己的网站名，如王小明的博客。
  version: "1.0.5", // 网站版本号
  iconBtnStart: 'html5', //主图标
  author: 'KINGWDY',//作者
  contactInformation: 'wudingyi1020@163.com',//联系方式
  officialWebsite: 'https://kwblog.netlify.app',//软件官网
  welcome: '本网站UI由 KWOS 强力驱动',//加载完毕控制台提示信息
  copyrightDetail: '版权归 KINGWDY© 所有',//版权详细信息
